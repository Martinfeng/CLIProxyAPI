...
const (
	defaultManagementReleaseURL  = "https://api.github.com/repos/seakee/CPA-Manager-Plus/releases/latest"
	defaultManagementFallbackURL = "https://github.com/seakee/CPA-Manager-Plus/releases/latest/download/management.html"
