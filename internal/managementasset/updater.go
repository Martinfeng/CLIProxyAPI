...
const (
	defaultManagementReleaseURL  = "https://api.github.com/repos/seakee/CPA-Manager/releases/latest"
	defaultManagementFallbackURL = "https://github.com/seakee/CPA-Manager/releases/latest/download/management.html"
